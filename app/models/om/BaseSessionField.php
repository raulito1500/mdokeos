...
/**
 * Base class that represents a row from the 'session_field' table.
 *
 * 
 *
 * @package    propel.generator.dokeos.om
 */
abstract class BaseSessionField extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'SessionFieldPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SessionFieldPeer
	 */
	...
	/**
	 * Initializes internal state of BaseSessionField object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     SessionField The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SessionFieldPeer::ID;
		}
	...
	public function setFieldType($v)
	{
		...
		if ($this->field_type !== $v || $this->isNew()) {
			$this->field_type = $v;
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_TYPE;
		}
	...
	public function setFieldVariable($v)
	{
		...
		if ($this->field_variable !== $v) {
			...
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_VARIABLE;
		}
	...
	public function setFieldDisplayText($v)
	{
		...
		if ($this->field_display_text !== $v) {
			...
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_DISPLAY_TEXT;
		}
	...
	public function setFieldDefaultValue($v)
	{
		...
		if ($this->field_default_value !== $v) {
			...
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_DEFAULT_VALUE;
		}
	...
	public function setFieldOrder($v)
	{
		...
		if ($this->field_order !== $v) {
			$this->field_order = $v;
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_ORDER;
		}
	...
	public function setFieldVisible($v)
	{
		...
		if ($this->field_visible !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_VISIBLE;
		}
	...
	public function setFieldChangeable($v)
	{
		...
		if ($this->field_changeable !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_CHANGEABLE;
		}
	...
	public function setFieldFilter($v)
	{
		...
		if ($this->field_filter !== $v || $this->isNew()) {
			$this->field_filter = $v;
			$this->modifiedColumns[] = SessionFieldPeer::FIELD_FILTER;
		}
	...
	public function setTms($v)
	{
		...
		if ( $this->tms !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SessionFieldPeer::TMS;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = SessionFieldPeer::NUM_COLUMNS - SessionFieldPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SessionField object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SessionFieldPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				SessionFieldPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SessionFieldPeer::ID) ) {
					...
					$affectedRows = SessionFieldPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SessionFieldPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SessionFieldPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SessionFieldPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SessionFieldPeer::ID)) $criteria->add(SessionFieldPeer::ID, $this->id);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_TYPE)) $criteria->add(SessionFieldPeer::FIELD_TYPE, $this->field_type);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_VARIABLE)) $criteria->add(SessionFieldPeer::FIELD_VARIABLE, $this->field_variable);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_DISPLAY_TEXT)) $criteria->add(SessionFieldPeer::FIELD_DISPLAY_TEXT, $this->field_display_text);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_DEFAULT_VALUE)) $criteria->add(SessionFieldPeer::FIELD_DEFAULT_VALUE, $this->field_default_value);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_ORDER)) $criteria->add(SessionFieldPeer::FIELD_ORDER, $this->field_order);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_VISIBLE)) $criteria->add(SessionFieldPeer::FIELD_VISIBLE, $this->field_visible);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_CHANGEABLE)) $criteria->add(SessionFieldPeer::FIELD_CHANGEABLE, $this->field_changeable);
		if ($this->isColumnModified(SessionFieldPeer::FIELD_FILTER)) $criteria->add(SessionFieldPeer::FIELD_FILTER, $this->field_filter);
		if ($this->isColumnModified(SessionFieldPeer::TMS)) $criteria->add(SessionFieldPeer::TMS, $this->tms);
	...
	{
		$criteria = new Criteria(SessionFieldPeer::DATABASE_NAME);
		$criteria->add(SessionFieldPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SessionField (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SessionField Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SessionFieldPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SessionFieldPeer();
		}
		return self::$peer;
	}
