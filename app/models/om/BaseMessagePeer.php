...
abstract class BaseMessagePeer {
	...
	const CLASS_DEFAULT = 'dokeos.Message';
	...
	/** the column name for the USER_SENDER_ID field */
	const USER_SENDER_ID = 'message.USER_SENDER_ID';

	/** the column name for the USER_RECEIVER_ID field */
	const USER_RECEIVER_ID = 'message.USER_RECEIVER_ID';

	/** the column name for the MSG_STATUS field */
	const MSG_STATUS = 'message.MSG_STATUS';

	/** the column name for the SEND_DATE field */
	const SEND_DATE = 'message.SEND_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserSenderId', 'UserReceiverId', 'MsgStatus', 'SendDate', 'Title', 'Content', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userSenderId', 'userReceiverId', 'msgStatus', 'sendDate', 'title', 'content', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_SENDER_ID, self::USER_RECEIVER_ID, self::MSG_STATUS, self::SEND_DATE, self::TITLE, self::CONTENT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_SENDER_ID', 'USER_RECEIVER_ID', 'MSG_STATUS', 'SEND_DATE', 'TITLE', 'CONTENT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_sender_id', 'user_receiver_id', 'msg_status', 'send_date', 'title', 'content', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserSenderId' => 1, 'UserReceiverId' => 2, 'MsgStatus' => 3, 'SendDate' => 4, 'Title' => 5, 'Content' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userSenderId' => 1, 'userReceiverId' => 2, 'msgStatus' => 3, 'sendDate' => 4, 'title' => 5, 'content' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_SENDER_ID => 1, self::USER_RECEIVER_ID => 2, self::MSG_STATUS => 3, self::SEND_DATE => 4, self::TITLE => 5, self::CONTENT => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_SENDER_ID' => 1, 'USER_RECEIVER_ID' => 2, 'MSG_STATUS' => 3, 'SEND_DATE' => 4, 'TITLE' => 5, 'CONTENT' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_sender_id' => 1, 'user_receiver_id' => 2, 'msg_status' => 3, 'send_date' => 4, 'title' => 5, 'content' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(MessagePeer::USER_SENDER_ID);
			$criteria->addSelectColumn(MessagePeer::USER_RECEIVER_ID);
			$criteria->addSelectColumn(MessagePeer::MSG_STATUS);
			$criteria->addSelectColumn(MessagePeer::SEND_DATE);
			$criteria->addSelectColumn(MessagePeer::TITLE);
			$criteria->addSelectColumn(MessagePeer::CONTENT);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.USER_SENDER_ID');
			$criteria->addSelectColumn($alias . '.USER_RECEIVER_ID');
			$criteria->addSelectColumn($alias . '.MSG_STATUS');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = MessagePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + MessagePeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? MessagePeer::CLASS_DEFAULT : MessagePeer::OM_CLASS;
	}
