...
abstract class BaseAdmin extends BaseObject  implements Persistent
{
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v || $this->isNew()) {
			$this->user_id = $v;
			$this->modifiedColumns[] = AdminPeer::USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = AdminPeer::NUM_COLUMNS - AdminPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AdminPeer::USER_ID)) $criteria->add(AdminPeer::USER_ID, $this->user_id);
	...
	{
		$criteria = new Criteria(AdminPeer::DATABASE_NAME);
		$criteria->add(AdminPeer::USER_ID, $this->user_id);
