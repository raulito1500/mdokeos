...
abstract class BaseClass extends BaseObject  implements Persistent
{
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ClassPeer::ID;
		}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v || $this->isNew()) {
			$this->code = $v;
			$this->modifiedColumns[] = ClassPeer::CODE;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ClassPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ClassPeer::NUM_COLUMNS - ClassPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ClassPeer::ID) ) {
					...
					$affectedRows = ClassPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClassPeer::ID)) $criteria->add(ClassPeer::ID, $this->id);
		if ($this->isColumnModified(ClassPeer::CODE)) $criteria->add(ClassPeer::CODE, $this->code);
		if ($this->isColumnModified(ClassPeer::NAME)) $criteria->add(ClassPeer::NAME, $this->name);
	...
	{
		$criteria = new Criteria(ClassPeer::DATABASE_NAME);
		$criteria->add(ClassPeer::ID, $this->id);
