...
abstract class BaseLanguagePeer {
	...
	const CLASS_DEFAULT = 'dokeos.Language';
	...
	const ORIGINAL_NAME = 'language.ORIGINAL_NAME';

	/** the column name for the ENGLISH_NAME field */
	const ENGLISH_NAME = 'language.ENGLISH_NAME';

	/** the column name for the ISOCODE field */
	const ISOCODE = 'language.ISOCODE';

	/** the column name for the DOKEOS_FOLDER field */
	const DOKEOS_FOLDER = 'language.DOKEOS_FOLDER';

	/** the column name for the AVAILABLE field */
	const AVAILABLE = 'language.AVAILABLE';

	/** the column name for the PARENT_ID field */
	const PARENT_ID = 'language.PARENT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'OriginalName', 'EnglishName', 'Isocode', 'DokeosFolder', 'Available', 'ParentId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'originalName', 'englishName', 'isocode', 'dokeosFolder', 'available', 'parentId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ORIGINAL_NAME, self::ENGLISH_NAME, self::ISOCODE, self::DOKEOS_FOLDER, self::AVAILABLE, self::PARENT_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ORIGINAL_NAME', 'ENGLISH_NAME', 'ISOCODE', 'DOKEOS_FOLDER', 'AVAILABLE', 'PARENT_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'original_name', 'english_name', 'isocode', 'dokeos_folder', 'available', 'parent_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'OriginalName' => 1, 'EnglishName' => 2, 'Isocode' => 3, 'DokeosFolder' => 4, 'Available' => 5, 'ParentId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'originalName' => 1, 'englishName' => 2, 'isocode' => 3, 'dokeosFolder' => 4, 'available' => 5, 'parentId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ORIGINAL_NAME => 1, self::ENGLISH_NAME => 2, self::ISOCODE => 3, self::DOKEOS_FOLDER => 4, self::AVAILABLE => 5, self::PARENT_ID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ORIGINAL_NAME' => 1, 'ENGLISH_NAME' => 2, 'ISOCODE' => 3, 'DOKEOS_FOLDER' => 4, 'AVAILABLE' => 5, 'PARENT_ID' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'original_name' => 1, 'english_name' => 2, 'isocode' => 3, 'dokeos_folder' => 4, 'available' => 5, 'parent_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LanguagePeer::ORIGINAL_NAME);
			$criteria->addSelectColumn(LanguagePeer::ENGLISH_NAME);
			$criteria->addSelectColumn(LanguagePeer::ISOCODE);
			$criteria->addSelectColumn(LanguagePeer::DOKEOS_FOLDER);
			$criteria->addSelectColumn(LanguagePeer::AVAILABLE);
			$criteria->addSelectColumn(LanguagePeer::PARENT_ID);
		} else {
			...
			$criteria->addSelectColumn($alias . '.DOKEOS_FOLDER');
