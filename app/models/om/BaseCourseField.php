...
/**
 * Base class that represents a row from the 'course_field' table.
 *
 * 
 *
 * @package    propel.generator.dokeos.om
 */
abstract class BaseCourseField extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'CourseFieldPeer';
	...
	/**
	 * Initializes internal state of BaseCourseField object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CourseField The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CourseFieldPeer::ID;
		}
	...
	public function setFieldType($v)
	{
		...
		if ($this->field_type !== $v || $this->isNew()) {
			$this->field_type = $v;
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_TYPE;
		}
	...
	public function setFieldVariable($v)
	{
		...
		if ($this->field_variable !== $v) {
			...
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_VARIABLE;
		}
	...
	public function setFieldDisplayText($v)
	{
		...
		if ($this->field_display_text !== $v) {
			...
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_DISPLAY_TEXT;
		}
	...
	public function setFieldDefaultValue($v)
	{
		...
		if ($this->field_default_value !== $v) {
			...
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_DEFAULT_VALUE;
		}
	...
	public function setFieldOrder($v)
	{
		...
		if ($this->field_order !== $v) {
			$this->field_order = $v;
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_ORDER;
		}
	...
	public function setFieldVisible($v)
	{
		...
		if ($this->field_visible !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_VISIBLE;
		}
	...
	public function setFieldChangeable($v)
	{
		...
		if ($this->field_changeable !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_CHANGEABLE;
		}
	...
	public function setFieldFilter($v)
	{
		...
		if ($this->field_filter !== $v || $this->isNew()) {
			$this->field_filter = $v;
			$this->modifiedColumns[] = CourseFieldPeer::FIELD_FILTER;
		}
	...
	public function setTms($v)
	{
		...
		if ( $this->tms !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CourseFieldPeer::TMS;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = CourseFieldPeer::NUM_COLUMNS - CourseFieldPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CourseField object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CourseFieldPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				CourseFieldPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(CourseFieldPeer::ID) ) {
					...
					$affectedRows = CourseFieldPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CourseFieldPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CourseFieldPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CourseFieldPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CourseFieldPeer::ID)) $criteria->add(CourseFieldPeer::ID, $this->id);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_TYPE)) $criteria->add(CourseFieldPeer::FIELD_TYPE, $this->field_type);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_VARIABLE)) $criteria->add(CourseFieldPeer::FIELD_VARIABLE, $this->field_variable);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_DISPLAY_TEXT)) $criteria->add(CourseFieldPeer::FIELD_DISPLAY_TEXT, $this->field_display_text);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_DEFAULT_VALUE)) $criteria->add(CourseFieldPeer::FIELD_DEFAULT_VALUE, $this->field_default_value);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_ORDER)) $criteria->add(CourseFieldPeer::FIELD_ORDER, $this->field_order);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_VISIBLE)) $criteria->add(CourseFieldPeer::FIELD_VISIBLE, $this->field_visible);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_CHANGEABLE)) $criteria->add(CourseFieldPeer::FIELD_CHANGEABLE, $this->field_changeable);
		if ($this->isColumnModified(CourseFieldPeer::FIELD_FILTER)) $criteria->add(CourseFieldPeer::FIELD_FILTER, $this->field_filter);
		if ($this->isColumnModified(CourseFieldPeer::TMS)) $criteria->add(CourseFieldPeer::TMS, $this->tms);
	...
	{
		$criteria = new Criteria(CourseFieldPeer::DATABASE_NAME);
		$criteria->add(CourseFieldPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CourseField (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CourseField Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CourseFieldPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CourseFieldPeer();
		}
		return self::$peer;
	}
