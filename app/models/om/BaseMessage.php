...
abstract class BaseMessage extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the user_sender_id field.
	 * @var        int
	 */
	protected $user_sender_id;

	/**
	 * The value for the user_receiver_id field.
	 * @var        int
	 */
	protected $user_receiver_id;

	/**
	 * The value for the msg_status field.
	...
	/**
	 * Get the [user_sender_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [user_receiver_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [msg_status] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [user_sender_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Message The current object (for fluent API support)
	 */
	public function setUserSenderId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->user_sender_id !== $v) {
			$this->user_sender_id = $v;
			$this->modifiedColumns[] = MessagePeer::USER_SENDER_ID;
		}
	...
	/**
	 * Set the value of [user_receiver_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Message The current object (for fluent API support)
	 */
	public function setUserReceiverId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->user_receiver_id !== $v) {
			$this->user_receiver_id = $v;
			$this->modifiedColumns[] = MessagePeer::USER_RECEIVER_ID;
		}
	...
	/**
	 * Set the value of [msg_status] column.
	 * 
	 * @param      int $v new value
	 * @return     Message The current object (for fluent API support)
	 */
	public function setMsgStatus($v)
	{
		...
		if ($this->msg_status !== $v || $this->isNew()) {
			$this->msg_status = $v;
			$this->modifiedColumns[] = MessagePeer::MSG_STATUS;
		}
	...
	public function setSendDate($v)
	{
		...
		if ( $this->send_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MessagePeer::SEND_DATE;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->user_sender_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->user_receiver_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->msg_status = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->send_date = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getUserSenderId();
				break;
			case 2:
				return $this->getUserReceiverId();
				break;
			case 3:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getUserSenderId(),
			$keys[2] => $this->getUserReceiverId(),
			$keys[3] => $this->getMsgStatus(),
			$keys[4] => $this->getSendDate(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setUserSenderId($value);
				break;
			case 2:
				$this->setUserReceiverId($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setUserSenderId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setUserReceiverId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setMsgStatus($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setSendDate($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagePeer::USER_SENDER_ID)) $criteria->add(MessagePeer::USER_SENDER_ID, $this->user_sender_id);
		if ($this->isColumnModified(MessagePeer::USER_RECEIVER_ID)) $criteria->add(MessagePeer::USER_RECEIVER_ID, $this->user_receiver_id);
		if ($this->isColumnModified(MessagePeer::MSG_STATUS)) $criteria->add(MessagePeer::MSG_STATUS, $this->msg_status);
		if ($this->isColumnModified(MessagePeer::SEND_DATE)) $criteria->add(MessagePeer::SEND_DATE, $this->send_date);
	...
	{
		$copyObj->setUserSenderId($this->user_sender_id);
		$copyObj->setUserReceiverId($this->user_receiver_id);
		$copyObj->setMsgStatus($this->msg_status);
	...
	{
		$this->id = null;
		$this->user_sender_id = null;
		$this->user_receiver_id = null;
