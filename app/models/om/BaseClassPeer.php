...
abstract class BaseClassPeer {
	...
	const CLASS_DEFAULT = 'dokeos.Class';
	...
	/**
	 * An identiy map to hold any loaded instances of Class objects.
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ClassPeer::ID);
			$criteria->addSelectColumn(ClassPeer::CODE);
			$criteria->addSelectColumn(ClassPeer::NAME);
		} else {
	 ...
	 *
	 * @param      Class $value A Class object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Class $obj, $key = null)
	{
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ClassPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ClassPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ClassPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? ClassPeer::CLASS_DEFAULT : ClassPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Class or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ClassPeer::ID) && $criteria->keyContainsValue(ClassPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ClassPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Class or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ClassPeer::ID);
			$value = $criteria->remove(ClassPeer::ID);
			if ($value) {
				$selectCriteria->add(ClassPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method perform a DELETE on the database, given a Class or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ClassPeer::ID, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Class $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ClassPeer::DATABASE_NAME);
			$criteria->add(ClassPeer::ID, $pks, Criteria::IN);
