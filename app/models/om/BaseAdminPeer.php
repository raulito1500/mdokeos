...
abstract class BaseAdminPeer {
	...
	const CLASS_DEFAULT = 'dokeos.Admin';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::USER_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, ),
		BasePeer::TYPE_NUM => array (0, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(AdminPeer::USER_ID);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = AdminPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + AdminPeer::NUM_COLUMNS;
		} else {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AdminPeer::USER_ID);
			$value = $criteria->remove(AdminPeer::USER_ID);
			if ($value) {
				$selectCriteria->add(AdminPeer::USER_ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AdminPeer::USER_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(AdminPeer::USER_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AdminPeer::DATABASE_NAME);
			$criteria->add(AdminPeer::USER_ID, $pks, Criteria::IN);
