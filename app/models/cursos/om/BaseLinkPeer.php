...
abstract class BaseLinkPeer {
	...
	const CLASS_DEFAULT = 'dokeos.Link';
	...
	const CATEGORY_ID = 'link.CATEGORY_ID';

	/** the column name for the DISPLAY_ORDER field */
	const DISPLAY_ORDER = 'link.DISPLAY_ORDER';

	/** the column name for the ON_HOMEPAGE field */
	const ON_HOMEPAGE = 'link.ON_HOMEPAGE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Url', 'Title', 'Description', 'CategoryId', 'DisplayOrder', 'OnHomepage', 'Target', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'url', 'title', 'description', 'categoryId', 'displayOrder', 'onHomepage', 'target', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::URL, self::TITLE, self::DESCRIPTION, self::CATEGORY_ID, self::DISPLAY_ORDER, self::ON_HOMEPAGE, self::TARGET, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'URL', 'TITLE', 'DESCRIPTION', 'CATEGORY_ID', 'DISPLAY_ORDER', 'ON_HOMEPAGE', 'TARGET', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'url', 'title', 'description', 'category_id', 'display_order', 'on_homepage', 'target', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Url' => 1, 'Title' => 2, 'Description' => 3, 'CategoryId' => 4, 'DisplayOrder' => 5, 'OnHomepage' => 6, 'Target' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'url' => 1, 'title' => 2, 'description' => 3, 'categoryId' => 4, 'displayOrder' => 5, 'onHomepage' => 6, 'target' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::URL => 1, self::TITLE => 2, self::DESCRIPTION => 3, self::CATEGORY_ID => 4, self::DISPLAY_ORDER => 5, self::ON_HOMEPAGE => 6, self::TARGET => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'URL' => 1, 'TITLE' => 2, 'DESCRIPTION' => 3, 'CATEGORY_ID' => 4, 'DISPLAY_ORDER' => 5, 'ON_HOMEPAGE' => 6, 'TARGET' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'url' => 1, 'title' => 2, 'description' => 3, 'category_id' => 4, 'display_order' => 5, 'on_homepage' => 6, 'target' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LinkPeer::DISPLAY_ORDER);
			$criteria->addSelectColumn(LinkPeer::ON_HOMEPAGE);
			$criteria->addSelectColumn(LinkPeer::TARGET);
		} else {
			...
			$criteria->addSelectColumn($alias . '.ON_HOMEPAGE');
