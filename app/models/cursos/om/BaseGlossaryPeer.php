...
abstract class BaseGlossaryPeer {
	...
	const CLASS_DEFAULT = 'dokeos.Glossary';
	...
	/** the column name for the GLOSSARY_ID field */
	const GLOSSARY_ID = 'glossary.GLOSSARY_ID';
	...
	const DISPLAY_ORDER = 'glossary.DISPLAY_ORDER';

	/**
	 * An identiy map to hold any loaded instances of Glossary objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('GlossaryId', 'Name', 'Description', 'DisplayOrder', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('glossaryId', 'name', 'description', 'displayOrder', ),
		BasePeer::TYPE_COLNAME => array (self::GLOSSARY_ID, self::NAME, self::DESCRIPTION, self::DISPLAY_ORDER, ),
		BasePeer::TYPE_RAW_COLNAME => array ('GLOSSARY_ID', 'NAME', 'DESCRIPTION', 'DISPLAY_ORDER', ),
		BasePeer::TYPE_FIELDNAME => array ('glossary_id', 'name', 'description', 'display_order', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('GlossaryId' => 0, 'Name' => 1, 'Description' => 2, 'DisplayOrder' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('glossaryId' => 0, 'name' => 1, 'description' => 2, 'displayOrder' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::GLOSSARY_ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::DISPLAY_ORDER => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('GLOSSARY_ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'DISPLAY_ORDER' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('glossary_id' => 0, 'name' => 1, 'description' => 2, 'display_order' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(GlossaryPeer::GLOSSARY_ID);
			$criteria->addSelectColumn(GlossaryPeer::NAME);
			$criteria->addSelectColumn(GlossaryPeer::DESCRIPTION);
			$criteria->addSelectColumn(GlossaryPeer::DISPLAY_ORDER);
		} else {
			$criteria->addSelectColumn($alias . '.GLOSSARY_ID');
	 ...
	 *
	 * @param      Glossary $value A Glossary object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Glossary $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getGlossaryId();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Glossary) {
				$key = (string) $value->getGlossaryId();
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = GlossaryPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = GlossaryPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + GlossaryPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? GlossaryPeer::CLASS_DEFAULT : GlossaryPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Glossary or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(GlossaryPeer::GLOSSARY_ID) && $criteria->keyContainsValue(GlossaryPeer::GLOSSARY_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.GlossaryPeer::GLOSSARY_ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Glossary or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(GlossaryPeer::GLOSSARY_ID);
			$value = $criteria->remove(GlossaryPeer::GLOSSARY_ID);
			if ($value) {
				$selectCriteria->add(GlossaryPeer::GLOSSARY_ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the glossary table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Glossary or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(GlossaryPeer::GLOSSARY_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(GlossaryPeer::GLOSSARY_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(GlossaryPeer::DATABASE_NAME);
			$criteria->add(GlossaryPeer::GLOSSARY_ID, $pks, Criteria::IN);
