...
/**
 * Base static class for performing query and update operations on the 'forum_category' table.
 *
 * 
 *
...
abstract class BaseForumCategoryPeer {
	...
	const CLASS_DEFAULT = 'dokeos.ForumCategory';
	...
	const CAT_ID = 'forum_category.CAT_ID';

	/** the column name for the CAT_TITLE field */
	const CAT_TITLE = 'forum_category.CAT_TITLE';

	/** the column name for the CAT_COMMENT field */
	const CAT_COMMENT = 'forum_category.CAT_COMMENT';

	/** the column name for the CAT_ORDER field */
	const CAT_ORDER = 'forum_category.CAT_ORDER';

	/** the column name for the LOCKED field */
	const LOCKED = 'forum_category.LOCKED';

	/** the column name for the SESSION_ID field */
	const SESSION_ID = 'forum_category.SESSION_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CatId', 'CatTitle', 'CatComment', 'CatOrder', 'Locked', 'SessionId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('catId', 'catTitle', 'catComment', 'catOrder', 'locked', 'sessionId', ),
		BasePeer::TYPE_COLNAME => array (self::CAT_ID, self::CAT_TITLE, self::CAT_COMMENT, self::CAT_ORDER, self::LOCKED, self::SESSION_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('CAT_ID', 'CAT_TITLE', 'CAT_COMMENT', 'CAT_ORDER', 'LOCKED', 'SESSION_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('cat_id', 'cat_title', 'cat_comment', 'cat_order', 'locked', 'session_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CatId' => 0, 'CatTitle' => 1, 'CatComment' => 2, 'CatOrder' => 3, 'Locked' => 4, 'SessionId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('catId' => 0, 'catTitle' => 1, 'catComment' => 2, 'catOrder' => 3, 'locked' => 4, 'sessionId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::CAT_ID => 0, self::CAT_TITLE => 1, self::CAT_COMMENT => 2, self::CAT_ORDER => 3, self::LOCKED => 4, self::SESSION_ID => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('CAT_ID' => 0, 'CAT_TITLE' => 1, 'CAT_COMMENT' => 2, 'CAT_ORDER' => 3, 'LOCKED' => 4, 'SESSION_ID' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('cat_id' => 0, 'cat_title' => 1, 'cat_comment' => 2, 'cat_order' => 3, 'locked' => 4, 'session_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ForumCategoryPeer::CAT_ID);
			$criteria->addSelectColumn(ForumCategoryPeer::CAT_TITLE);
			$criteria->addSelectColumn(ForumCategoryPeer::CAT_COMMENT);
			$criteria->addSelectColumn(ForumCategoryPeer::CAT_ORDER);
			$criteria->addSelectColumn(ForumCategoryPeer::LOCKED);
			$criteria->addSelectColumn(ForumCategoryPeer::SESSION_ID);
		} else {
			$criteria->addSelectColumn($alias . '.CAT_ID');
			$criteria->addSelectColumn($alias . '.CAT_TITLE');
			$criteria->addSelectColumn($alias . '.CAT_COMMENT');
	...
	/**
	 * Method to invalidate the instance pool of all tables related to forum_category
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ForumCategoryPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ForumCategoryPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ForumCategoryPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? ForumCategoryPeer::CLASS_DEFAULT : ForumCategoryPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ForumCategory or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ForumCategoryPeer::CAT_ID) && $criteria->keyContainsValue(ForumCategoryPeer::CAT_ID) ) {
	...
	/**
	 * Method perform an UPDATE on the database, given a ForumCategory or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ForumCategoryPeer::CAT_ID);
			$value = $criteria->remove(ForumCategoryPeer::CAT_ID);
			if ($value) {
				$selectCriteria->add(ForumCategoryPeer::CAT_ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the forum_category table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ForumCategory or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ForumCategoryPeer::CAT_ID, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(ForumCategory $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ForumCategoryPeer::CAT_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ForumCategoryPeer::DATABASE_NAME);
			$criteria->add(ForumCategoryPeer::CAT_ID, $pks, Criteria::IN);
