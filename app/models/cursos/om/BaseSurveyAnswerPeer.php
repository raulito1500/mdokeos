...
/**
 * Base static class for performing query and update operations on the 'survey_answer' table.
 *
 * 
 *
...
abstract class BaseSurveyAnswerPeer {
	...
	const CLASS_DEFAULT = 'dokeos.SurveyAnswer';
	...
	const ANSWER_ID = 'survey_answer.ANSWER_ID';

	/** the column name for the SURVEY_ID field */
	const SURVEY_ID = 'survey_answer.SURVEY_ID';

	/** the column name for the QUESTION_ID field */
	const QUESTION_ID = 'survey_answer.QUESTION_ID';

	/** the column name for the OPTION_ID field */
	const OPTION_ID = 'survey_answer.OPTION_ID';

	/** the column name for the VALUE field */
	const VALUE = 'survey_answer.VALUE';

	/** the column name for the USER field */
	const USER = 'survey_answer.USER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('AnswerId', 'SurveyId', 'QuestionId', 'OptionId', 'Value', 'User', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('answerId', 'surveyId', 'questionId', 'optionId', 'value', 'user', ),
		BasePeer::TYPE_COLNAME => array (self::ANSWER_ID, self::SURVEY_ID, self::QUESTION_ID, self::OPTION_ID, self::VALUE, self::USER, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ANSWER_ID', 'SURVEY_ID', 'QUESTION_ID', 'OPTION_ID', 'VALUE', 'USER', ),
		BasePeer::TYPE_FIELDNAME => array ('answer_id', 'survey_id', 'question_id', 'option_id', 'value', 'user', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('AnswerId' => 0, 'SurveyId' => 1, 'QuestionId' => 2, 'OptionId' => 3, 'Value' => 4, 'User' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('answerId' => 0, 'surveyId' => 1, 'questionId' => 2, 'optionId' => 3, 'value' => 4, 'user' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ANSWER_ID => 0, self::SURVEY_ID => 1, self::QUESTION_ID => 2, self::OPTION_ID => 3, self::VALUE => 4, self::USER => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ANSWER_ID' => 0, 'SURVEY_ID' => 1, 'QUESTION_ID' => 2, 'OPTION_ID' => 3, 'VALUE' => 4, 'USER' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('answer_id' => 0, 'survey_id' => 1, 'question_id' => 2, 'option_id' => 3, 'value' => 4, 'user' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(SurveyAnswerPeer::ANSWER_ID);
			$criteria->addSelectColumn(SurveyAnswerPeer::SURVEY_ID);
			$criteria->addSelectColumn(SurveyAnswerPeer::QUESTION_ID);
			$criteria->addSelectColumn(SurveyAnswerPeer::OPTION_ID);
			$criteria->addSelectColumn(SurveyAnswerPeer::VALUE);
			$criteria->addSelectColumn(SurveyAnswerPeer::USER);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to survey_answer
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(SurveyAnswerPeer::ANSWER_ID) && $criteria->keyContainsValue(SurveyAnswerPeer::ANSWER_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SurveyAnswerPeer::ANSWER_ID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SurveyAnswerPeer::ANSWER_ID);
			$value = $criteria->remove(SurveyAnswerPeer::ANSWER_ID);
			if ($value) {
				$selectCriteria->add(SurveyAnswerPeer::ANSWER_ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the survey_answer table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SurveyAnswerPeer::ANSWER_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SurveyAnswerPeer::ANSWER_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SurveyAnswerPeer::DATABASE_NAME);
			$criteria->add(SurveyAnswerPeer::ANSWER_ID, $pks, Criteria::IN);
