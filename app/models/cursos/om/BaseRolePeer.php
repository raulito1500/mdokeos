...
abstract class BaseRolePeer {
	...
	const CLASS_DEFAULT = 'dokeos.Role';
	...
	/** the column name for the ROLE_COMMENT field */
	const ROLE_COMMENT = 'role.ROLE_COMMENT';

	/** the column name for the DEFAULT_ROLE field */
	const DEFAULT_ROLE = 'role.DEFAULT_ROLE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('RoleId', 'RoleName', 'RoleComment', 'DefaultRole', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('roleId', 'roleName', 'roleComment', 'defaultRole', ),
		BasePeer::TYPE_COLNAME => array (self::ROLE_ID, self::ROLE_NAME, self::ROLE_COMMENT, self::DEFAULT_ROLE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ROLE_ID', 'ROLE_NAME', 'ROLE_COMMENT', 'DEFAULT_ROLE', ),
		BasePeer::TYPE_FIELDNAME => array ('role_id', 'role_name', 'role_comment', 'default_role', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('RoleId' => 0, 'RoleName' => 1, 'RoleComment' => 2, 'DefaultRole' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('roleId' => 0, 'roleName' => 1, 'roleComment' => 2, 'defaultRole' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ROLE_ID => 0, self::ROLE_NAME => 1, self::ROLE_COMMENT => 2, self::DEFAULT_ROLE => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ROLE_ID' => 0, 'ROLE_NAME' => 1, 'ROLE_COMMENT' => 2, 'DEFAULT_ROLE' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('role_id' => 0, 'role_name' => 1, 'role_comment' => 2, 'default_role' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(RolePeer::ROLE_ID);
			$criteria->addSelectColumn(RolePeer::ROLE_NAME);
			$criteria->addSelectColumn(RolePeer::ROLE_COMMENT);
			$criteria->addSelectColumn(RolePeer::DEFAULT_ROLE);
		} else {
			$criteria->addSelectColumn($alias . '.ROLE_ID');
			$criteria->addSelectColumn($alias . '.ROLE_NAME');
			$criteria->addSelectColumn($alias . '.ROLE_COMMENT');
			$criteria->addSelectColumn($alias . '.DEFAULT_ROLE');
		}
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(RolePeer::ROLE_ID) && $criteria->keyContainsValue(RolePeer::ROLE_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.RolePeer::ROLE_ID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(RolePeer::ROLE_ID);
			$value = $criteria->remove(RolePeer::ROLE_ID);
			if ($value) {
				$selectCriteria->add(RolePeer::ROLE_ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(RolePeer::ROLE_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(RolePeer::ROLE_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(RolePeer::DATABASE_NAME);
			$criteria->add(RolePeer::ROLE_ID, $pks, Criteria::IN);
