...
abstract class BaseRoleUser extends BaseObject  implements Persistent
{
	...
	public function setScope($v)
	{
		...
		if ($this->scope !== $v || $this->isNew()) {
			$this->scope = $v;
			$this->modifiedColumns[] = RoleUserPeer::SCOPE;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RoleUserPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = RoleUserPeer::NUM_COLUMNS - RoleUserPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(RoleUserPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoleUserPeer::SCOPE)) $criteria->add(RoleUserPeer::SCOPE, $this->scope);
		if ($this->isColumnModified(RoleUserPeer::USER_ID)) $criteria->add(RoleUserPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(RoleUserPeer::ID)) $criteria->add(RoleUserPeer::ID, $this->id);
	...
	{
		$criteria = new Criteria(RoleUserPeer::DATABASE_NAME);
		$criteria->add(RoleUserPeer::ID, $this->id);
