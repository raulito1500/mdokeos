...
/**
 * Base static class for performing query and update operations on the 'quiz_question' table.
 *
 * 
 *
...
abstract class BaseQuizQuestionPeer {
	...
	const CLASS_DEFAULT = 'dokeos.QuizQuestion';
	...
	const ID = 'quiz_question.ID';

	/** the column name for the QUESTION field */
	const QUESTION = 'quiz_question.QUESTION';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'quiz_question.DESCRIPTION';

	/** the column name for the PONDERATION field */
	const PONDERATION = 'quiz_question.PONDERATION';

	/** the column name for the POSITION field */
	const POSITION = 'quiz_question.POSITION';

	/** the column name for the TYPE field */
	const TYPE = 'quiz_question.TYPE';

	/** the column name for the PICTURE field */
	const PICTURE = 'quiz_question.PICTURE';

	/** the column name for the LEVEL field */
	const LEVEL = 'quiz_question.LEVEL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Question', 'Description', 'Ponderation', 'Position', 'Type', 'Picture', 'Level', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'question', 'description', 'ponderation', 'position', 'type', 'picture', 'level', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::QUESTION, self::DESCRIPTION, self::PONDERATION, self::POSITION, self::TYPE, self::PICTURE, self::LEVEL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'QUESTION', 'DESCRIPTION', 'PONDERATION', 'POSITION', 'TYPE', 'PICTURE', 'LEVEL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'question', 'description', 'ponderation', 'position', 'type', 'picture', 'level', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Question' => 1, 'Description' => 2, 'Ponderation' => 3, 'Position' => 4, 'Type' => 5, 'Picture' => 6, 'Level' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'question' => 1, 'description' => 2, 'ponderation' => 3, 'position' => 4, 'type' => 5, 'picture' => 6, 'level' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::QUESTION => 1, self::DESCRIPTION => 2, self::PONDERATION => 3, self::POSITION => 4, self::TYPE => 5, self::PICTURE => 6, self::LEVEL => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'QUESTION' => 1, 'DESCRIPTION' => 2, 'PONDERATION' => 3, 'POSITION' => 4, 'TYPE' => 5, 'PICTURE' => 6, 'LEVEL' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'question' => 1, 'description' => 2, 'ponderation' => 3, 'position' => 4, 'type' => 5, 'picture' => 6, 'level' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(QuizQuestionPeer::ID);
			$criteria->addSelectColumn(QuizQuestionPeer::QUESTION);
			$criteria->addSelectColumn(QuizQuestionPeer::DESCRIPTION);
			$criteria->addSelectColumn(QuizQuestionPeer::PONDERATION);
			$criteria->addSelectColumn(QuizQuestionPeer::POSITION);
			$criteria->addSelectColumn(QuizQuestionPeer::TYPE);
			$criteria->addSelectColumn(QuizQuestionPeer::PICTURE);
			$criteria->addSelectColumn(QuizQuestionPeer::LEVEL);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to quiz_question
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = QuizQuestionPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + QuizQuestionPeer::NUM_COLUMNS;
		} else {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(QuizQuestionPeer::ID) && $criteria->keyContainsValue(QuizQuestionPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.QuizQuestionPeer::ID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(QuizQuestionPeer::ID);
			$value = $criteria->remove(QuizQuestionPeer::ID);
			if ($value) {
				$selectCriteria->add(QuizQuestionPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the quiz_question table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(QuizQuestionPeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(QuizQuestionPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(QuizQuestionPeer::DATABASE_NAME);
			$criteria->add(QuizQuestionPeer::ID, $pks, Criteria::IN);
