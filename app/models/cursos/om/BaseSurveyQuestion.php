...
abstract class BaseSurveyQuestion extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the shared_question_id field.
	 * @var        int
	 */
	...
	/**
	 * The value for the survey_group_pri field.
	...
	/**
	 * The value for the survey_group_sec1 field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	...
	/**
	 * The value for the survey_group_sec2 field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	...
	{
		$this->survey_group_pri = 0;
		$this->survey_group_sec1 = 0;
		$this->survey_group_sec2 = 0;
	}
	...
	/**
	 * Get the [shared_question_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [survey_group_pri] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [survey_group_sec1] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [survey_group_sec2] column value.
	 * 
	 * @return     int
	 */
	...
	public function setQuestionId($v)
	{
		...
		if ($this->question_id !== $v) {
			$this->question_id = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::QUESTION_ID;
		}
	...
	public function setSurveyId($v)
	{
		...
		if ($this->survey_id !== $v) {
			$this->survey_id = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_ID;
		}
	...
	public function setSurveyQuestion($v)
	{
		...
		if ($this->survey_question !== $v) {
			...
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_QUESTION;
		}
	...
	public function setSurveyQuestionComment($v)
	{
		...
		if ($this->survey_question_comment !== $v) {
			...
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_QUESTION_COMMENT;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::TYPE;
		}
	...
	public function setDisplay($v)
	{
		...
		if ($this->display !== $v) {
			$this->display = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::DISPLAY;
		}
	...
	public function setSort($v)
	{
		...
		if ($this->sort !== $v) {
			$this->sort = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SORT;
		}
	...
	/**
	 * Set the value of [shared_question_id] column.
	 * 
	 * @param      int $v new value
	 * @return     SurveyQuestion The current object (for fluent API support)
	 */
	public function setSharedQuestionId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->shared_question_id !== $v) {
			$this->shared_question_id = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SHARED_QUESTION_ID;
		}
	...
	public function setMaxValue($v)
	{
		...
		if ($this->max_value !== $v) {
			$this->max_value = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::MAX_VALUE;
		}
	...
	/**
	 * Set the value of [survey_group_pri] column.
	 * 
	 * @param      int $v new value
	 * @return     SurveyQuestion The current object (for fluent API support)
	 */
	public function setSurveyGroupPri($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->survey_group_pri !== $v || $this->isNew()) {
			$this->survey_group_pri = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_GROUP_PRI;
		}
	...
	/**
	 * Set the value of [survey_group_sec1] column.
	 * 
	 * @param      int $v new value
	 * @return     SurveyQuestion The current object (for fluent API support)
	 */
	public function setSurveyGroupSec1($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->survey_group_sec1 !== $v || $this->isNew()) {
			$this->survey_group_sec1 = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_GROUP_SEC1;
		}
	...
	/**
	 * Set the value of [survey_group_sec2] column.
	 * 
	 * @param      int $v new value
	 * @return     SurveyQuestion The current object (for fluent API support)
	 */
	public function setSurveyGroupSec2($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->survey_group_sec2 !== $v || $this->isNew()) {
			$this->survey_group_sec2 = $v;
			$this->modifiedColumns[] = SurveyQuestionPeer::SURVEY_GROUP_SEC2;
		}
	...
	{
			if ($this->survey_group_pri !== 0) {
				return false;
			}

			if ($this->survey_group_sec1 !== 0) {
				return false;
			}

			if ($this->survey_group_sec2 !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->shared_question_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->max_value = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->survey_group_pri = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->survey_group_sec1 = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->survey_group_sec2 = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->resetModified();
			...
			return $startcol + 12; // 12 = SurveyQuestionPeer::NUM_COLUMNS - SurveyQuestionPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SurveyQuestionPeer::QUESTION_ID) ) {
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				return $this->getSharedQuestionId();
				break;
			case 8:
				return $this->getMaxValue();
				break;
			case 9:
				return $this->getSurveyGroupPri();
				break;
			case 10:
				return $this->getSurveyGroupSec1();
				break;
			case 11:
				return $this->getSurveyGroupSec2();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getSort(),
			$keys[7] => $this->getSharedQuestionId(),
			$keys[8] => $this->getMaxValue(),
			$keys[9] => $this->getSurveyGroupPri(),
			$keys[10] => $this->getSurveyGroupSec1(),
			$keys[11] => $this->getSurveyGroupSec2(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setSharedQuestionId($value);
				break;
			case 8:
				$this->setMaxValue($value);
				break;
			case 9:
				$this->setSurveyGroupPri($value);
				break;
			case 10:
				$this->setSurveyGroupSec1($value);
				break;
			case 11:
				$this->setSurveyGroupSec2($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setSharedQuestionId($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setMaxValue($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setSurveyGroupPri($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setSurveyGroupSec1($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setSurveyGroupSec2($arr[$keys[11]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SurveyQuestionPeer::QUESTION_ID)) $criteria->add(SurveyQuestionPeer::QUESTION_ID, $this->question_id);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_ID)) $criteria->add(SurveyQuestionPeer::SURVEY_ID, $this->survey_id);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_QUESTION)) $criteria->add(SurveyQuestionPeer::SURVEY_QUESTION, $this->survey_question);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_QUESTION_COMMENT)) $criteria->add(SurveyQuestionPeer::SURVEY_QUESTION_COMMENT, $this->survey_question_comment);
		if ($this->isColumnModified(SurveyQuestionPeer::TYPE)) $criteria->add(SurveyQuestionPeer::TYPE, $this->type);
		if ($this->isColumnModified(SurveyQuestionPeer::DISPLAY)) $criteria->add(SurveyQuestionPeer::DISPLAY, $this->display);
		if ($this->isColumnModified(SurveyQuestionPeer::SORT)) $criteria->add(SurveyQuestionPeer::SORT, $this->sort);
		if ($this->isColumnModified(SurveyQuestionPeer::SHARED_QUESTION_ID)) $criteria->add(SurveyQuestionPeer::SHARED_QUESTION_ID, $this->shared_question_id);
		if ($this->isColumnModified(SurveyQuestionPeer::MAX_VALUE)) $criteria->add(SurveyQuestionPeer::MAX_VALUE, $this->max_value);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_GROUP_PRI)) $criteria->add(SurveyQuestionPeer::SURVEY_GROUP_PRI, $this->survey_group_pri);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_GROUP_SEC1)) $criteria->add(SurveyQuestionPeer::SURVEY_GROUP_SEC1, $this->survey_group_sec1);
		if ($this->isColumnModified(SurveyQuestionPeer::SURVEY_GROUP_SEC2)) $criteria->add(SurveyQuestionPeer::SURVEY_GROUP_SEC2, $this->survey_group_sec2);
	...
	{
		$criteria = new Criteria(SurveyQuestionPeer::DATABASE_NAME);
		$criteria->add(SurveyQuestionPeer::QUESTION_ID, $this->question_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setSharedQuestionId($this->shared_question_id);
		$copyObj->setMaxValue($this->max_value);
		$copyObj->setSurveyGroupPri($this->survey_group_pri);
		$copyObj->setSurveyGroupSec1($this->survey_group_sec1);
		$copyObj->setSurveyGroupSec2($this->survey_group_sec2);
	...
	public function clear()
	{
		...
		$this->display = null;
		$this->sort = null;
		$this->shared_question_id = null;
		$this->max_value = null;
		$this->survey_group_pri = null;
		$this->survey_group_sec1 = null;
		$this->survey_group_sec2 = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
