...
abstract class BaseDocument extends BaseObject  implements Persistent
{
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = DocumentPeer::COMMENT;
		}
	...
	public function setFiletype($v)
	{
		...
		if ($this->filetype !== $v || $this->isNew()) {
			$this->filetype = $v;
			$this->modifiedColumns[] = DocumentPeer::FILETYPE;
		}
	...
	/**
	 * Set the value of [readonly] column.
	 * 
	 * @param      int $v new value
	 * @return     Document The current object (for fluent API support)
	 */
	public function setReadonly($v)
	{
		...
		if ($this->readonly !== $v) {
			$this->readonly = $v;
			$this->modifiedColumns[] = DocumentPeer::READONLY;
		}
	...
	public function setSessionId($v)
	{
		...
		if ($this->session_id !== $v || $this->isNew()) {
			$this->session_id = $v;
			$this->modifiedColumns[] = DocumentPeer::SESSION_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->filetype = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->size = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->readonly = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			...
			return $startcol + 8; // 8 = DocumentPeer::NUM_COLUMNS - DocumentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getFiletype(),
			$keys[5] => $this->getSize(),
			$keys[6] => $this->getReadonly(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setFiletype($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setSize($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setReadonly($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocumentPeer::COMMENT)) $criteria->add(DocumentPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(DocumentPeer::TITLE)) $criteria->add(DocumentPeer::TITLE, $this->title);
		if ($this->isColumnModified(DocumentPeer::FILETYPE)) $criteria->add(DocumentPeer::FILETYPE, $this->filetype);
		if ($this->isColumnModified(DocumentPeer::SIZE)) $criteria->add(DocumentPeer::SIZE, $this->size);
		if ($this->isColumnModified(DocumentPeer::READONLY)) $criteria->add(DocumentPeer::READONLY, $this->readonly);
		if ($this->isColumnModified(DocumentPeer::SESSION_ID)) $criteria->add(DocumentPeer::SESSION_ID, $this->session_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setReadonly($this->readonly);
