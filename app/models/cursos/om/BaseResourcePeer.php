...
/**
 * Base static class for performing query and update operations on the 'resource' table.
 *
 * 
 *
...
abstract class BaseResourcePeer {
	...
	const CLASS_DEFAULT = 'dokeos.Resource';
	...
	/** the column name for the SOURCE_TYPE field */
	const SOURCE_TYPE = 'resource.SOURCE_TYPE';

	/** the column name for the SOURCE_ID field */
	const SOURCE_ID = 'resource.SOURCE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'SourceType', 'SourceId', 'ResourceType', 'ResourceId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'sourceType', 'sourceId', 'resourceType', 'resourceId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SOURCE_TYPE, self::SOURCE_ID, self::RESOURCE_TYPE, self::RESOURCE_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SOURCE_TYPE', 'SOURCE_ID', 'RESOURCE_TYPE', 'RESOURCE_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'source_type', 'source_id', 'resource_type', 'resource_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SourceType' => 1, 'SourceId' => 2, 'ResourceType' => 3, 'ResourceId' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'sourceType' => 1, 'sourceId' => 2, 'resourceType' => 3, 'resourceId' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SOURCE_TYPE => 1, self::SOURCE_ID => 2, self::RESOURCE_TYPE => 3, self::RESOURCE_ID => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SOURCE_TYPE' => 1, 'SOURCE_ID' => 2, 'RESOURCE_TYPE' => 3, 'RESOURCE_ID' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'source_type' => 1, 'source_id' => 2, 'resource_type' => 3, 'resource_id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ResourcePeer::SOURCE_TYPE);
			$criteria->addSelectColumn(ResourcePeer::SOURCE_ID);
			$criteria->addSelectColumn(ResourcePeer::RESOURCE_TYPE);
			$criteria->addSelectColumn(ResourcePeer::RESOURCE_ID);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.SOURCE_TYPE');
	...
	/**
	 * Method to DELETE all rows from the resource table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
