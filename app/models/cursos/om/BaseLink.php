...
abstract class BaseLink extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the on_homepage field.
	 * Note: this column has a database default value of: '0'
	 * @var        string
	 */
	...
	/**
	 * Get the [on_homepage] column value.
	 * 
	 * @return     string
	 */
	...
	public function setDisplayOrder($v)
	{
		...
		if ($this->display_order !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = LinkPeer::DISPLAY_ORDER;
		}
	...
	/**
	 * Set the value of [on_homepage] column.
	 * 
	 * @param      string $v new value
	 * @return     Link The current object (for fluent API support)
	 */
	public function setOnHomepage($v)
	{
		...
		if ($this->on_homepage !== $v || $this->isNew()) {
			$this->on_homepage = $v;
			$this->modifiedColumns[] = LinkPeer::ON_HOMEPAGE;
		}
	...
	public function setTarget($v)
	{
		...
		if ($this->target !== $v || $this->isNew()) {
			$this->target = $v;
			$this->modifiedColumns[] = LinkPeer::TARGET;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->display_order = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->on_homepage = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->target = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = LinkPeer::NUM_COLUMNS - LinkPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setOnHomepage($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LinkPeer::DISPLAY_ORDER)) $criteria->add(LinkPeer::DISPLAY_ORDER, $this->display_order);
		if ($this->isColumnModified(LinkPeer::ON_HOMEPAGE)) $criteria->add(LinkPeer::ON_HOMEPAGE, $this->on_homepage);
		if ($this->isColumnModified(LinkPeer::TARGET)) $criteria->add(LinkPeer::TARGET, $this->target);
