...
abstract class BaseCalendarEventPeer {
	...
	const CLASS_DEFAULT = 'dokeos.CalendarEvent';
	...
	const CONTENT = 'calendar_event.CONTENT';

	/** the column name for the START_DATE field */
	const START_DATE = 'calendar_event.START_DATE';

	/** the column name for the END_DATE field */
	const END_DATE = 'calendar_event.END_DATE';

	/** the column name for the PARENT_EVENT_ID field */
	const PARENT_EVENT_ID = 'calendar_event.PARENT_EVENT_ID';

	/** the column name for the SESSION_ID field */
	const SESSION_ID = 'calendar_event.SESSION_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Content', 'StartDate', 'EndDate', 'ParentEventId', 'SessionId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'content', 'startDate', 'endDate', 'parentEventId', 'sessionId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::CONTENT, self::START_DATE, self::END_DATE, self::PARENT_EVENT_ID, self::SESSION_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'CONTENT', 'START_DATE', 'END_DATE', 'PARENT_EVENT_ID', 'SESSION_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'content', 'start_date', 'end_date', 'parent_event_id', 'session_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Content' => 2, 'StartDate' => 3, 'EndDate' => 4, 'ParentEventId' => 5, 'SessionId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'startDate' => 3, 'endDate' => 4, 'parentEventId' => 5, 'sessionId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::CONTENT => 2, self::START_DATE => 3, self::END_DATE => 4, self::PARENT_EVENT_ID => 5, self::SESSION_ID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'CONTENT' => 2, 'START_DATE' => 3, 'END_DATE' => 4, 'PARENT_EVENT_ID' => 5, 'SESSION_ID' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'content' => 2, 'start_date' => 3, 'end_date' => 4, 'parent_event_id' => 5, 'session_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CalendarEventPeer::CONTENT);
			$criteria->addSelectColumn(CalendarEventPeer::START_DATE);
			$criteria->addSelectColumn(CalendarEventPeer::END_DATE);
			$criteria->addSelectColumn(CalendarEventPeer::PARENT_EVENT_ID);
			$criteria->addSelectColumn(CalendarEventPeer::SESSION_ID);
		} else {
			...
			$criteria->addSelectColumn($alias . '.PARENT_EVENT_ID');
	 ...
	 *
	 * @param      CalendarEvent $value A CalendarEvent object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(CalendarEvent $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = CalendarEventPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + CalendarEventPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? CalendarEventPeer::CLASS_DEFAULT : CalendarEventPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a CalendarEvent or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a CalendarEvent or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the calendar_event table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a CalendarEvent or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(CalendarEvent $obj, $cols = null)
	{
		$columns = array();
