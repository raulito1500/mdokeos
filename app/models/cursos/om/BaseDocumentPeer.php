...
abstract class BaseDocumentPeer {
	...
	const CLASS_DEFAULT = 'dokeos.Document';
	...
	const SESSION_ID = 'document.SESSION_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Path', 'Comment', 'Title', 'Filetype', 'Size', 'Readonly', 'SessionId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'path', 'comment', 'title', 'filetype', 'size', 'readonly', 'sessionId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PATH, self::COMMENT, self::TITLE, self::FILETYPE, self::SIZE, self::READONLY, self::SESSION_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PATH', 'COMMENT', 'TITLE', 'FILETYPE', 'SIZE', 'READONLY', 'SESSION_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'path', 'comment', 'title', 'filetype', 'size', 'readonly', 'session_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Path' => 1, 'Comment' => 2, 'Title' => 3, 'Filetype' => 4, 'Size' => 5, 'Readonly' => 6, 'SessionId' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'path' => 1, 'comment' => 2, 'title' => 3, 'filetype' => 4, 'size' => 5, 'readonly' => 6, 'sessionId' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PATH => 1, self::COMMENT => 2, self::TITLE => 3, self::FILETYPE => 4, self::SIZE => 5, self::READONLY => 6, self::SESSION_ID => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PATH' => 1, 'COMMENT' => 2, 'TITLE' => 3, 'FILETYPE' => 4, 'SIZE' => 5, 'READONLY' => 6, 'SESSION_ID' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'path' => 1, 'comment' => 2, 'title' => 3, 'filetype' => 4, 'size' => 5, 'readonly' => 6, 'session_id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(DocumentPeer::COMMENT);
			$criteria->addSelectColumn(DocumentPeer::TITLE);
			$criteria->addSelectColumn(DocumentPeer::FILETYPE);
			$criteria->addSelectColumn(DocumentPeer::SIZE);
			$criteria->addSelectColumn(DocumentPeer::READONLY);
			$criteria->addSelectColumn(DocumentPeer::SESSION_ID);
		} else {
	...
	/**
	 * Method to DELETE all rows from the document table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
