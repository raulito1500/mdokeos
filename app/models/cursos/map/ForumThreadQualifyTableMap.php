...
/**
 * This class defines the structure of the 'forum_thread_qualify' table.
 *
 *
 *
 ...
 */
class ForumThreadQualifyTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'dokeos.map.ForumThreadQualifyTableMap';
	...
	{
	  // attributes
		$this->setName('forum_thread_qualify');
		$this->setPhpName('ForumThreadQualify');
		$this->setClassname('ForumThreadQualify');
