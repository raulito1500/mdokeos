...
/**
 * This class defines the structure of the 'session_field' table.
 *
 *
 *
 ...
 */
class SessionFieldTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'dokeos.map.SessionFieldTableMap';
	...
	{
	  // attributes
		$this->setName('session_field');
		$this->setPhpName('SessionField');
		$this->setClassname('SessionField');
